...
class DepthCapturePass : CustomPass
{
    ...
    protected override void Execute(ScriptableRenderContext renderContext, CommandBuffer cmd, HDCamera hdCamera, CullingResults cullingResult)
    {
        ...
        if (render && hdCamera.camera != bakeCamera && hdCamera.camera.cameraType != CameraType.SceneView)
        {
            ...
            var result = new UnityEngine.Rendering.RendererUtils.RendererListDesc(shaderTags, cullingResult, bakeCamera)
            {
            ...
            HDUtils.DrawRendererList(renderContext, cmd, renderContext.CreateRendererList(result));
